...
public class update_Data extends AppCompatActivity {
    ...
    TextInputEditText tv_namet,tv_mobilek,tv_emailj;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_namet = findViewById(R.id.edName);
        tv_mobilek =findViewById(R.id.edNumber);
        tv_emailj =findViewById(R.id.edEmail);
 ...
 public void lodData(){
     ...
     RequestQueue requestQueue= Volley.newRequestQueue(update_Data.this);
